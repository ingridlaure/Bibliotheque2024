...
public class Gestion {
        ...
        public static void main(String[] args) {
            ...
            Ouvrage l = new Livre("Vingt mille lieues sous les mers",10, LocalDate.of(1880,1,1),LIVRE,1.50,"français","aventure","a125",350,ROMAN,"histoire de sous-marin");
